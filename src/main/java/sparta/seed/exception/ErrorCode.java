...
public enum ErrorCode {
    ...
    UNKNOWN_ERROR(HttpStatus.BAD_REQUEST, "403", "토큰이 존재하지 않습니다."),
    WRONG_TYPE_TOKEN(HttpStatus.BAD_REQUEST, "402", "변조된 토큰입니다."),
    ...
    NOT_PARTICIPATED(HttpStatus.BAD_REQUEST,"400","캠페인 참가자만 인증글/댓글을 작성할 수 있습니다."),
